...
public class GroupBuyAdapter extends CommonViewAdapter<HomePageBean.DataBean.GroupBuyingBean.PromotionGoodsListBean> {
   private int groupNum;
    public GroupBuyAdapter(Context context, List<HomePageBean.DataBean.GroupBuyingBean.PromotionGoodsListBean> datas) {
        super(context, datas,  R.layout.item_group_buy);
    }


    @Override
    public void convert(ViewHolder holder, HomePageBean.DataBean.GroupBuyingBean.PromotionGoodsListBean item) {
