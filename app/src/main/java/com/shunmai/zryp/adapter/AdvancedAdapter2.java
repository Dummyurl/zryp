 ...
 */
public abstract class AdvancedAdapter2 extends RecyclerView.Adapter<ViewHolder> {
    ...
    protected abstract void onBindAdvanceViewHolder(ViewHolder holder, int i);

    protected abstract ViewHolder onCreateAdvanceViewHolder(ViewGroup parent, int viewType);
