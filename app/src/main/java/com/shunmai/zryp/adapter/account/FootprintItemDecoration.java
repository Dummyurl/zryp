...
public class FootprintItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static final String TAG = FootprintItemDecoration.class.getSimpleName();
    private Context mContext;
    private ArrayList<FootprintBean.DataBean> mDataList = new ArrayList<>();
    ...
    public FootprintItemDecoration(Context context, ArrayList<FootprintBean.DataBean> dataList, OnDecorationCallback onDecorationCallback) {
        ...
        mPaint = new Paint();
        mPaint.setColor(resources.getColor(R.color.color_page_bg));
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (pos == 0 || isGroupFirstItem(pos)){
            ...
            if (mDataList.get(pos).getTime().equals(""))
                outRect.top = 0;
        }else {
            outRect.top = 0;
        }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i=0; i<childCount; i++){
            ...
            if (groupId.equals("-1"))
                return;
            String textLine = mOnDecorationCallback.onGroupFirstStr(pos);
            if (textLine.equals("")){
...
//                    c.drawText("更多>>", right, bottom, mTextPaint1);
                }
            }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i=0; i<childCount; i++){
            ...
            if (groupId.equals("-1") || groupId.equals(preGroupId))
                continue;
            String textLine = mOnDecorationCallback.onGroupFirstStr(position);
