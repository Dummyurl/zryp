...
//                        Log.i(TAG,"mSeconds="+mSeconds+"#what_count_down_tick:"+second2TimeSecond(mSeconds)+"#"+String.format(mStrFormat,second2TimeSecond(mSeconds)));
...
//        Log.e(TAG,"removeOnAttachStateChangeListener");
    ...
    private String second2TimeSecond(long second) {
        ...
        if (days>=1){
            return days+"天 "+hourString + ":" + minuteString+":"+secondString;
        }else{
