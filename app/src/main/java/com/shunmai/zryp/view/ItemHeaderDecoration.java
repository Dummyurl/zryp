...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    ItemHeaderDecoration(Context context, List<GoodsCategoryBean> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<GoodsCategoryBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        ...
        tvTitle.setText(mDatas.get(pos).getTitle());
        //绘制title开始
